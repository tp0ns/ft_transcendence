...
export declare function generate(lsType: 'template' | 'script', fileName: string, script: undefined | {
    ...
    content: string;
}, scriptRanges: ScriptRanges | undefined, scriptSetupRanges: ScriptSetupRanges | undefined, getHtmlGen: () => ReturnType<typeof templateGen['generate']> | undefined, getStyleBindTexts: () => string[], shimComponentOptions: boolean, downgradePropsAndEmitsToSetupReturnOnScriptSetup: boolean, vueVersion: number): {
